...
If you are using link:ROSA[https://aws.amazon.com/blogs/containers/announcing-red-hat-openshift-service-on-aws/] you can carry over your AWS credentials into the docker container has the devcontainer mounts your `~/.aws/` directory into the docker user (`jboss`) home directory.
